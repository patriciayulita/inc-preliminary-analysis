...
gwet_inter_se_ex <- sum_inter_ex$coefficients[1, "Std. Error"]
...
cohen_inter_se_ex <- sum_inter_ex$coefficients[1, "Std. Error"]
...
gwet_intra_se_ex <- sum_intra_ex$coefficients[1, "Std. Error"]
...
cohen_intra_se_ex <- sum_intra_ex$coefficients[1, "Std. Error"]
