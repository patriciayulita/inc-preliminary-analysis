...
gwet_inter_se_ox <- mean(gwetse_inter_all)
...
cohen_inter_se_ox <- mean(ckappase_inter_all)
...
gwet_intra_se_ox <- mean(gwetse_intra_all)
...
cohen_intra_se_ox <- mean(ckappase_intra_all)
