...
gwet_inter_se_ucl <- mean(gwetse_inter_all)
...
cohen_inter_se_ucl <- mean(ckappase_inter_all)
...
gwet_intra_se_ucl <- mean(gwetse_intra_all)
...
cohen_intra_se_ucl <- mean(ckappase_intra_all)
