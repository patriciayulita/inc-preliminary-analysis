...
remotes::install_github("kgwet/irrCAC")
...
raw_inter_r1o1_r2o1 <- read.csv("epoch_id_responses_interrater_r1o1_r2o1_ox.csv")
inter_r1o1_r2o1_in <-subset(raw_inter_r1o1_r2o1, ! (epoch %in% id_ex))
inter_r1o1_r2o1 <- inter_r1o1_r2o1_in[,col_extract]
write.csv(inter_r1o1_r2o1,"inter_r1o1_r2o1_ox_eligible.csv", row.names = FALSE)
...
gwet_inter_r1o1_r2o1_altman_ox <- altman.bf(ac1coeff_inter_r1o1_r2o1, ac1se_inter_r1o1_r2o1)
...
ckappa_inter_r1o1_r2o1_altman_ox <- altman.bf(ckappacoeff_inter_r1o1_r2o1, ckappase_inter_r1o1_r2o1)

# inter_r1o1_r2o2

raw_inter_r1o1_r2o2 <- read.csv("epoch_id_responses_interrater_r1o1_r2o2_ox.csv")
inter_r1o1_r2o2_in <-subset(raw_inter_r1o1_r2o2, ! (epoch %in% id_ex))
inter_r1o1_r2o2 <- inter_r1o1_r2o2_in[,col_extract]
write.csv(inter_r1o1_r2o2,"inter_r1o1_r2o2_ox_eligible.csv", row.names = FALSE)
...
gwet_inter_r1o1_r2o2_altman_ox <- altman.bf(ac1coeff_inter_r1o1_r2o2, ac1se_inter_r1o1_r2o2)
...
ckappa_inter_r1o1_r2o2_altman_ox <- altman.bf(ckappacoeff_inter_r1o1_r2o2, ckappase_inter_r1o1_r2o2)

# inter_r1o2_r2o1

raw_inter_r1o2_r2o1 <- read.csv("epoch_id_responses_interrater_r1o2_r2o1_ox.csv")
inter_r1o2_r2o1_in <-subset(raw_inter_r1o2_r2o1, ! (epoch %in% id_ex))
inter_r1o2_r2o1 <- inter_r1o2_r2o1_in[,col_extract]
write.csv(inter_r1o2_r2o1,"inter_r1o2_r2o1_ox_eligible.csv", row.names = FALSE)
...
gwet_inter_r1o2_r2o1_altman_ox <- altman.bf(ac1coeff_inter_r1o2_r2o1, ac1se_inter_r1o2_r2o1)
...
ckappa_inter_r1o2_r2o1_altman_ox <- altman.bf(ckappacoeff_inter_r1o2_r2o1, ckappase_inter_r1o2_r2o1)

# inter_r1o2_r2o2

raw_inter_r1o2_r2o2 <- read.csv("epoch_id_responses_interrater_r1o2_r2o2_ox.csv")
inter_r1o2_r2o2_in <-subset(raw_inter_r1o2_r2o2, ! (epoch %in% id_ex))
inter_r1o2_r2o2 <- inter_r1o2_r2o2_in[,col_extract]
write.csv(inter_r1o2_r2o2,"inter_r1o2_r2o2_ox_eligible.csv", row.names = FALSE)
...
gwet_inter_r1o2_r2o2_altman_ox <- altman.bf(ac1coeff_inter_r1o2_r2o2, ac1se_inter_r1o2_r2o2)
...
ckappa_inter_r1o2_r2o2_altman_ox <- altman.bf(ckappacoeff_inter_r1o2_r2o2, ckappase_inter_r1o2_r2o2)
...
# OLS Gwet's
inter_reliability_ox <- lm(y~1)
sum_inter_ox <- summary(inter_reliability_ox)

gwet_inter_coef_ox <- sum_inter_ox$coefficients[1, "Estimate"]
gwet_inter_se_ox <- sum_inter_ox$coefficients[1, "Std. Error"]

gwet_inter_altman_ox <- altman.bf(gwet_inter_coef_ox, gwet_inter_se_ox)
...
cohen_inter_coef_ox <- sum_inter_ox$coefficients[1, "Estimate"]
cohen_inter_se_ox <- sum_inter_ox$coefficients[1, "Std. Error"]

cohen_inter_altman_ox <- altman.bf(cohen_inter_coef_ox, cohen_inter_se_ox)



# intra_rater1
raw_intra_r1 <- read.csv("epoch_id_responses_intrarater1_ox.csv")
intra_r1_in <-subset(raw_intra_r1, ! (epoch %in% id_ex))

col_extract_intra <- c("r1o1","r1o2")
intra_r1 <- intra_r1_in[,col_extract_intra]
write.csv(intra_r1,"intra_r1_ox_eligible.csv", row.names = FALSE)
...
gwet_intra_r1_altman_ox <- altman.bf(ac1coeff_intra_r1, ac1se_intra_r1)
...
raw_intra_r2 <- read.csv("epoch_id_responses_intrarater2_ox.csv")
intra_r2_in <-subset(raw_intra_r2, ! (epoch %in% id_ex))

col_extract_intra <- c("r2o1","r2o2")
intra_r2 <- intra_r2_in[,col_extract_intra]
write.csv(intra_r2,"intra_r2_ox_eligible.csv", row.names = FALSE)
...
gwet_intra_r2_altman_ox <- altman.bf(ac1coeff_intra_r2, ac1se_intra_r2)
...
ckappa_intra_r2_altman_ox <- altman.bf(ckappacoeff_intra_r2, ckappase_intra_r2)
...
# OLS Gwet's
intra_reliability_ox <- lm(y~1)
sum_intra_ox <- summary(intra_reliability_ox)

gwet_intra_coef_ox <- sum_intra_ox$coefficients[1, "Estimate"]
gwet_intra_se_ox <- sum_intra_ox$coefficients[1, "Std. Error"]

intra_altman_ox <- altman.bf(gwet_intra_coef_ox, gwet_intra_se_ox)
...
cohen_intra_coef_ox <- sum_intra_ox$coefficients[1, "Estimate"]
cohen_intra_se_ox <- sum_intra_ox$coefficients[1, "Std. Error"]

intra_altman_ox <- altman.bf(cohen_intra_coef_ox, cohen_intra_se_ox)
